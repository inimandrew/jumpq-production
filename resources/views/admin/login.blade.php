...
<link rel="icon" type="image/png" sizes="16x16" href="{{url('assets/administrator/plugins/images/favicon.png')}}">
<title>{{$app_name}} - Administrator Login</title>
...
<section id="wrapper" class="new-login-register">
      <div class="lg-info-panel">
              <div class="inner-panel">
                  <a href="javascript:void(0)" class="p-20 di"><img src="{{url('assets/administrator/plugins/images/admin-logo.png')}}"></a>
              </div>
      </div>
                ...
                <div class="white-box">
                  ...
                  <form class="form-horizontal new-lg-form" id="loginform" autocomplete="off">
                    ...
                    <div class="form-group text-center m-t-20">
                      <div class="col-xs-12">
                        <button class="btn btn-info btn-lg btn-block btn-rounded text-uppercase waves-effect waves-light" id="submit" type="submit">Log In</button>
                      </div>
                    </div>
...
<!--Style Switcher -->
<script src="{{url('assets/administrator/plugins/bower_components/styleswitcher/jQuery.style.switcher.js')}}"></script>
