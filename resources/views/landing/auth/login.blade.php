            ...
            <div class="mx-auto mb-4 w-4/5">
                ...
                <form class="space-y-4" autocomplete="off" method="POST" id="login-user">
                    <div class="relative w-full">
                        <input type="text" name="username" class="pl-10 py-4 rounded-lg border border-gray-400 w-full placeholder-gray-600 focus:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent" placeholder="Email Address" />
