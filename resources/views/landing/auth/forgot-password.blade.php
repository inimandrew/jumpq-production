        ...
        <div class="flex items-center bg-white shadow-2xl rounded-none md:rounded-l-3xl">
            <div class="mx-auto mb-4 w-4/5">
                <div class="text-center space-y-2 mb-4">
                    ...
                    <p class=" tracking-widest color-app font-medium text-lg">Recover Password</p>
                </div>
                ...
                <form class="space-y-4" method="POST" autocomplete="off" id="login-user">
                    <div class="relative w-full">
                        <input type="email" required name="email" class="pl-10 py-4 rounded-lg border border-gray-400 w-full placeholder-gray-600 focus:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent" placeholder="Email Address" />
