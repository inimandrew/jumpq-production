            ...
            <div class="container">
                <div class="classy-nav-container breakpoint-off">
                    <nav class="classy-navbar" id="bigshopNav">
                        <!-- Nav Brand--><a class="nav-brand" href="{{url('/')}}"><img
                                src="{{asset('assets/main/JumPQ-logo/default.png')}}" alt="logo" width="140"
                                height="35"></a>
                        <!-- Toggler-->
                        ...
                        <div class="hero_meta_area ml-auto d-flex align-items-center justify-content-end">
                            ...
                            <div class="account-area">
                                <div class="user-thumbnail"><img
                                        src="{{route('profile_pic',[Auth::guard('user')->user()->profile_image_location])}}"
                                        width="40" height="40"></div>
                                <ul class="user-meta-dropdown">
                                    <li class="user-title"><span>Hello,</span>
                                        {{Auth::guard('user')->user()->firstname}} </li>
                            ...
                            <div class="account-area">
                                ...
                                <ul class="user-meta-dropdown">
                                    <li class="user-title"><span>Hello,</span>
                                        {{Auth::guard('ads')->user()->company_name}} </li>
                            ...
                            <div class="account-area">
                                ...
                                <ul class="user-meta-dropdown">
                                    <li><a class="btn btn-success btn-sm auth-buttons"
                                            style="color:white;font-size:18px;font-weight:bold;"
                                            href="{{route('sign_in')}}">Login</a></li>
                                    <li><a class="btn btn-primary btn-sm auth-buttons"
                                            style="color:white;font-size:18px;font-weight:bold;"
                                            href="{{route('sign_up')}}">Sign-up</a></li>
